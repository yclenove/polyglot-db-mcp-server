...
**当前基线**: v2.2.1
**状态**: 当前有效
**当前详细迭代**: `docs/ITER-v1.7.1-迭代计划.md`、`docs/ITER-v1.7.2-迭代计划.md`、`docs/ITER-v1.7.3-迭代计划.md`、`docs/ITER-v1.8.0-迭代计划.md`、`docs/ITER-v1.9.0-迭代计划.md`、`docs/ITER-v2.0.0-迭代计划.md`、`docs/ITER-v2.0.1-迭代计划.md`、`docs/ITER-v2.1.0-迭代计划.md`、`docs/ITER-v2.1.1-迭代计划.md`、`docs/ITER-v2.2.0-迭代计划.md`、`docs/ITER-v2.2.1-迭代计划.md`
**文档索引**: `docs/INDEX.md`
...
- 已支持 HTTP Bearer Token、RBAC policy、统一授权 wrapper、授权审计、auth 诊断工具和请求级 policy 脱敏。
...
| Phase 5 | v2.2.0 ~ v2.2.x | 2027 Q2 | 可观测与治理 | Prometheus/OTel 可观测基线、审计文件持久化和 policy 模板已完成；告警与外部 sink 继续进入 v2.2.x |
...
**状态**: Prometheus/OTel 可观测基线、审计文件持久化和 RBAC policy 模板已完成；告警 webhook、外部 sink、OTel exporter 配置和审批式策略治理进入 v2.2.x 后续。
...
| P1 | 告警 webhook | v2.2.x 后续：连接失败、错误率升高、慢查询、频繁写操作 |
| P1 | 审计持久化 | 已完成文件 JSONL sink；外部数据库/webhook sink 后续 |
...
1. v2.2.x：推进告警 webhook、OTel exporter 配置、外部审计 sink 和审批式策略治理。
...
1. v2.2.x 继续推进 OTel exporter、告警 webhook、外部审计 sink 和审批式策略治理。
